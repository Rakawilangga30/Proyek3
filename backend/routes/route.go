...
func RegisterRoutes(r *gin.Engine) {
    ...
    // Purchase Check Endpoint (BARU)
    // Endpoint ini yang akan dipanggil oleh frontend sebelum menampilkan tombol "Beli" atau "Akses Materi"
    ...
    user.GET("/sessions/:sessionID/media",
        ...
        controllers.GetUserSessionMedia, // <--- UBAH INI (Pakai GetUserSessionMedia)
    )
    ...
    // // HAPUS middlewares.AuthRequired() di sini juga
    ...
    // Ambil media (Note: Ini untuk Organisasi melihat list, bukan untuk User)
