...
function OrgWithdraw() {
    ...
    return (
        <div className="org-withdraw">
            <h2>💰 Tarik Dana Organisasi</h2>
            ...
            <style>{`
                .org-withdraw { max-width: 800px; margin: 0 auto; padding: 20px; }
                ...
                .btn-withdraw { background: linear-gradient(135deg, #3b82f6, #2563eb); border: none; color: white; padding: 14px 32px; border-radius: 10px; font-weight: 600; font-size: 16px; cursor: pointer; }
                ...
                .btn-submit { padding: 12px 24px; border-radius: 8px; border: none; background: linear-gradient(135deg, #3b82f6, #2563eb); color: white; font-weight: 600; cursor: pointer; }
            `}</style>
        </div>
    );
}
